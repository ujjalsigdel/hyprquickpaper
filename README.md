...
HyprQuickPaper comes with multiple visual layouts, including Bottom Dock (default), 3D Coverflow, Floating Glassmorphism, and Hexacomb grids. 

**➡️ [Click here to view the full Layouts Showcase & Gallery](docs/LAYOUTS.md)**

![Bottom Dock](assets/screenshots/bottom-dock.jpg)
*The default Bottom Dock layout.*
---
